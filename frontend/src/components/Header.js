            ...
            <ul class="flex text-white">
              <li>
                <div class="flex items-center">
                  ...
                  <span class="ml-2">178 Phase-8, Indore, MP, INDIA</span>
                </div>
              </li>
              <li class="ml-6">
                <div class="flex items-center">
            ...
            <nav
              ...
              <ul class="md:flex items-center">
                ...
                <li class="md:ml-4"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold" to="contact-us">Contact
                  Us</Link></li>
                {userData._id ? (<li class="md:ml-4 md:hidden lg:block"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold"
                  to="login" onClick={handleLogout}>Logout</Link></li>) : (<li class="md:ml-4 md:hidden lg:block"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold"
                    to="login">Login</Link></li>)}
                <li class="md:ml-4"><Link class="py-2 inline-block md:text-white md:px-2 font-semibold" to="/signup">Sign up</Link></li>
